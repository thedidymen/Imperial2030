...
class CreateGame(object):
	...
	def __init__(self, superpowers=None, interests=None, bonds=None, areas=None, homecities=None, naval=None, army=None, players=None, land=None, sea=None, canals=None):
		...
		if land == None:
			self.land = ['Canada', 'Manaus', 'Paris', 'Guinea', 'Rio de Janeiro', 'Fortaleza', 'San Francisco', 'Argentina', 'Australia', 'Iran', 'North-Africa', 'Mumbai', 'East-Africa', 'Near East', 'New-Zeeland', 'Alaska', 'Rome', 'Beijing', 'South-Africa', 'New Orleans', 'London', 'Colombia', 'Brasillia', 'Turkey', 'Afghanistan', 'Indochina', 'Vladivostok', 'Chicago', 'Shanghai', 'Mongolia', 'Philppines', 'Peru', 'Kolkata', 'Nigeria', 'Korea', 'Moscow', 'Berlin', 'New York', 'Kazakhstan', 'Quebec', 'Ukraine', 'Murmansk', 'Indonesia', 'Urumqi', 'Chennai', 'New Delhi', 'Mexico', 'Novasibirsk', 'Congo', 'Chongging', 'Japan']
		else:
			self.land = land

		if sea == None:
			self.sea = ['Gulf of Guinea', 'Caribbean Sea', 'Tasman Sea', 'South Atlantic', 'Mediterranean Sea', 'North Atlantic', 'China Sea', 'South Pacific', 'Sea of Japan', 'North Pacific', 'Indian Ocean']
		else:
			self.sea = sea

		if canals == None:
			self.canals = ['Colombia', 'North-Africa']
		else:
			self.canals = canals
